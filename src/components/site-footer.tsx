  ...
  return (
    <footer className="border-t border-paper/15 bg-ink text-paper">
      <div className="mx-auto max-w-6xl px-4 pt-16 pb-28 sm:px-6 sm:pt-24 md:pb-24">
        <p className="flex items-center gap-3 text-3xl text-paper sm:text-4xl">
          <SignMark className="h-14 sm:h-16 brightness-110" />
          <Wordmark />
        </p>
        <div className="mt-10 grid gap-10 sm:grid-cols-2 sm:items-end">
          <div>
            <p className="kicker text-paper/80">Address</p>
            ...
            <p className="mt-5">
              <a
                ...
                className="text-link font-display text-xl text-paper/90 underline decoration-paper/25 underline-offset-4 hover:decoration-paper"
              >
                {CAFE.phoneDisplay}
              </a>
            </p>
          </div>
          <div className="flex flex-col gap-1 text-sm text-paper/85 sm:items-end">
            <a
              href={CAFE.facebook}
              className="text-link text-paper underline decoration-paper/25 underline-offset-4 hover:decoration-paper"
            >
              Facebook
            </a>
